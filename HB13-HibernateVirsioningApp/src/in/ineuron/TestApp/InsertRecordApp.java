...
public class InsertRecordApp {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			...
			if (transaction != null) {
				MobileCustomer mocust = new MobileCustomer();
				mocust.setcName("akshay");
				mocust.setcMobileNumber(7498943919L);
				mocust.setcCallertune("phone utha phone utha..");
				

				id =(Integer) session.save(mocust);
